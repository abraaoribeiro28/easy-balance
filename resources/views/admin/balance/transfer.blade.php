<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-12 py-6 px-4 sm:px-6 lg:px-8">
        <div class="relative overflow-x-auto sm:rounded-lg">
            ...
            @endforeach
            @endisset
            <aside class="p-4 my-3 bg-white border border-gray-200 rounded-lg shadow-md 
                        ...
                        <div data-style="clean" class="flex items-end mb-3">
                            ...
                            <div data-element="fields" data-stacked="false"
                                ...
                                <div class="relative w-full mr-3 formkit-field">
                                    ...
                                    <input id="value" class="formkit-input bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
