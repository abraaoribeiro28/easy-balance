    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-2">
            {{-- <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">Lembrar senha</span>
            </label> --}}
        ...
        <div class="flex items-center justify-end mt-4">
            {{-- <a href="{{route('register')}}" class='inline-flex items-center px-4 py-2 bg-gray-800 ml-3
